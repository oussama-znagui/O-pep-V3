...
<body>
    <header class ='h-screen bg-[conic-gradient(at_bottom_right,_var(--tw-gradient-stops))] from-green-200 to-green-500  flex justify-center items-center p-10 flex-col  '>
        ...
        <form id="form" class="w-full max-w-lg bg-gray-300 p-10 rounded-xl">
  <div class="flex flex-wrap -mx-3">
    ...
    <div class="w-full my-3  ">
      ...
      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="mail" type="email" placeholder="email.pro@mail.com">
    </div>
    <div class="w-full ">
      <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-password">
        Mot de pass
    ...
    <div class="w-full  flex justify-center items-center">
      <input class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded " value="Valider" type="submit" id = 'go'>    
    </div>  
</form>
