  ...
  <div class="flex w-full flex-wrap items-center justify-between px-3">
    ...
    <div class="relative flex items-center">
     ...
     <div tabsindex="0" class="group relative inline-block p-5">
        ...
        <div class="h-2/4   flex justify-between items-center w-4/5 mx-auto my-10">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4 my-8">
    ...
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="rounded-t-lg h-2/4 w-full" src="media/image.png" alt="" />
                </a>
                <div class="p-5">
                    <a href="#">
                        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white"><?php echo $row->__get("nom") ?></h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700 dark:text-gray-400"><?php echo $row->__get("idCategorie") ?></p>
